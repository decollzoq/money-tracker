...
import TransactionInputModal from "./component/TransactionInputModal";
...
function App() {
    ...
    function saveTransaction(item) {
        if (editingItem) {
            setTransactions(
                transactions.map((t) => (t.id === item.id ? item : t)),
            );
        } else {
                ...
                <div className="header">
                    ...
                    <div className="month-section">
                        ...
                        <button
                            ...
                            style={{
                                color: isTodayMonth && "var(--gray100)",
                        ...
                        <div className="alert-container">
                            ...
                            <div className="button-group">
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        deleteTransaction(deleteItem.id)
                                    }
                                >
                                    확인
                                </button>
